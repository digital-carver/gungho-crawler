...
HTTP通信は非同期で行われるならもちろんDNS通信も非同期で行えます。
...
DoSを引き起こす可能性があります。このセキュリティリスクをGunghoを監視します。
...
高く、ひょっとするとLWP::UserAgentのようなモジュールを使ったほうが良いかも
しれません。

もちろんLWP::UserAgentには存在しないGunghoの機能を使用するためにGunghoを
使うのもよいかも知れませんが、チューニングが必要であることを認識していて
ください
